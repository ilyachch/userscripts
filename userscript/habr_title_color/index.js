...
(function () {
  ...
  document
    .querySelector('h1[data-test-id="articleTitle"]')
    .addEventListener("click", colorize_header);
})();

function colorize_header() {
  let title_block = document.querySelector('h1[data-test-id="articleTitle"]');
  let title_el = document.querySelector('h1[data-test-id="articleTitle"] span');
